...
export const fetchActivities = async (): Promise<Activity[]> => {
  try {
    ...
    return [
      ...
      {
        id: 10,
        title: "Latihan Panjat Tebing di Pacet",
        description: "Kegiatan latihan panjat tebing untuk anggota Mahapala Narotama di area Pacet, Mojokerto. Peserta dilatih teknik dasar panjat tebing, rappelling, dan penyelamatan. Kegiatan ini merupakan bagian dari program peningkatan kompetensi anggota.",
        date: new Date("2024-03-10"),
        imageUrl: "https://images.unsplash.com/photo-1522163182402-834f871fd851?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&h=658",
        category: "Edukasi",
      },
      {
        id: 11,
        title: "Ekspedisi Penelitian Terumbu Karang Pulau Bawean",
        description: "Ekspedisi penelitian kondisi terumbu karang di perairan Pulau Bawean, Jawa Timur. Tim melakukan pemetaan, dokumentasi, dan analisis kesehatan ekosistem terumbu karang sebagai dasar program konservasi laut di masa depan.",
        date: new Date("2024-02-22"),
        imageUrl: "https://images.unsplash.com/photo-1546026423-cc4642628d2b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&h=658",
        category: "Ekspedisi",
      },
      {
        id: 12,
        title: "Pengamatan Burung Migran di Pantai Timur Surabaya",
        description: "Kegiatan pengamatan burung-burung migran di kawasan konservasi mangrove Pantai Timur Surabaya (Pamurbaya). Data yang dikumpulkan akan digunakan untuk mendukung upaya perlindungan habitat burung migran di kawasan pesisir Surabaya.",
        date: new Date("2024-02-05"),
        imageUrl: "https://images.unsplash.com/photo-1452570053594-1b985d6ea890?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&h=658",
        category: "Konservasi",
      },
      {
        id: 13,
        title: "Pelatihan SAR Dasar di Gunung Penanggungan",
        description: "Pelatihan Search and Rescue (SAR) dasar untuk anggota Mahapala Narotama di kawasan Gunung Penanggungan. Materi meliputi teknik pencarian korban, evakuasi medis darurat, dan koordinasi tim penyelamatan di medan pegunungan.",
        date: new Date("2024-01-15"),
        imageUrl: "https://images.unsplash.com/photo-1495527400402-02a863e68766?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&h=658",
        category: "Edukasi",
      },
      {
        id: 14,
        title: "Forum Diskusi Konservasi Satwa Langka",
        description: "Forum diskusi ilmiah tentang konservasi satwa langka di Indonesia, dengan fokus pada spesies endemik Jawa Timur. Dihadiri oleh perwakilan dari berbagai UKM Pecinta Alam se-Jawa Timur dan pakar konservasi dari LIPI.",
        date: new Date("2023-12-20"),
        imageUrl: "https://images.unsplash.com/photo-1581537583727-83f84aa6d22d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&h=658",
        category: "Edukasi",
      },
      {
        id: 15,
        title: "Pemetaan Jalur Pendakian Arjuno-Welirang",
        description: "Kegiatan pemetaan ulang jalur pendakian Gunung Arjuno-Welirang untuk pembaruan data geografis dan titik-titik penting seperti sumber air, shelter, dan area berbahaya. Hasil pemetaan akan dibagikan kepada komunitas pendaki dan pihak pengelola.",
        date: new Date("2023-11-28"),
        imageUrl: "https://images.unsplash.com/photo-1454496522488-7a8e488e8606?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&h=658",
        category: "Ekspedisi",
      },
      {
        id: 16,
        title: "Program Rehabilitasi Mangrove Sidoarjo",
        description: "Program rehabilitasi ekosistem mangrove di wilayah terdampak lumpur Lapindo, Sidoarjo. Kegiatan meliputi penanaman 2000 bibit mangrove dan pembangunan fasilitas edukasi konservasi mangrove untuk masyarakat setempat.",
        date: new Date("2023-11-05"),
        imageUrl: "https://images.unsplash.com/photo-1598060030077-a84a9120fe16?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&h=658",
        category: "Konservasi",
      },
      {
        id: 17,
        title: "Pendakian dan Upacara 17 Agustus di Puncak Butak",
        description: "Pendakian dan penyelenggaraan upacara pengibaran bendera merah putih di Puncak Gunung Butak dalam rangka peringatan HUT RI. Kegiatan ini diikuti oleh gabungan Mapala dari beberapa universitas di Jawa Timur.",
        date: new Date("2023-08-17"),
        imageUrl: "https://images.unsplash.com/photo-1533577116850-9cc66cad8a9b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&h=658",
        category: "Ekspedisi",
      },
      {
        id: 18,
        title: "Kampanye Pendakian Zero Waste di Rinjani",
        description: "Kegiatan kampanye pendakian ramah lingkungan dengan prinsip Zero Waste di Gunung Rinjani. Selain edukasi kepada pendaki, tim juga melakukan pembersihan sampah di jalur pendakian dan pembagian trash bag ramah lingkungan.",
        date: new Date("2023-07-02"),
        imageUrl: "https://images.unsplash.com/photo-1508193638397-1c4234db14d8?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&h=658",
        category: "Konservasi",
      },
      {
        id: 19,
        title: "Festival Film Dokumenter Lingkungan",
        description: "Penyelenggaraan festival film dokumenter bertema lingkungan dan konservasi alam di kampus Universitas Narotama. Acara diisi dengan pemutaran film, diskusi dengan filmmaker, dan workshop pembuatan film dokumenter lingkungan.",
        date: new Date("2023-06-10"),
        imageUrl: "https://images.unsplash.com/photo-1478720568477-152d9b164e26?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&h=658",
        category: "Edukasi",
      }
    ];
  }
